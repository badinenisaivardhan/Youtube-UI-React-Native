  ...
  return (
    <View style={{width:width,alignSelf:'center',marginTop:-30}}>
        <View>
            ...
            <Image source={require('../assets/videos/harry-potter.jpg')} style={{width:width,height:300,resizeMode:'contain',alignSelf:'center',alignContent:'center',alignItems:'center'}} />
